...
if (!dialang.session.reviewMode) {
    ...
    $.get('/content/baskets/' + dialang.session.al + "/" + dialang.pass.currentBasketId + '.html', function (data) {
            ...
            success: function (nextBasketData, textStatus, jqXHR, jqFormElement) {
                ...
                if (nextBasketData.redirect) {
                    ...
                    if (dialang.session.instantFeedbackOn) {
                        ...
                        } else if (scoredBasket.type === 'tabbedpane' ) {
                        ...
                        } else if (scoredBasket.type === 'gapdrop') {
                        ...
                        } else if (scoredBasket.type === 'shortanswer' || scoredBasket.type === 'gaptext') {
    ...
    $.get('/content/baskets/' + dialang.session.al + "/" + reviewBasket.id + '.html', function (data) {
        ...
        } else if (reviewBasket.type === 'tabbedpane' ) {
        ...
        } else if (reviewBasket.type === 'gapdrop') {
        ...
        } else if (reviewBasket.type === 'shortanswer' || reviewBasket.type === 'gaptext') {
            // Launch the dialog
            dialang.launchMultiItemReviewDialog(reviewBasket,positionInBasket, function (clickedItemId) {
